...
//Ball Variables
int ball_x = 21; // Initial x position of the ball
int ball_y = 44; // Initial y position of the ball
...
void adc_int(void) interrupt 15 {
	...
	dataOut = (dataOut * ((100L - paddle_len)+1)) >> 12;
	//averaged = 0;
